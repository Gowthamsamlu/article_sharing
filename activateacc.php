<!DOCTYPE html>
    <html lang="en">
      <head>
          <title>Create your TechPost account</title>
        ...
        <center>
          <div style="width:65%;text-align:left;border-radius:5pt; border:solid 1px #999;padding-top:15pt;padding-left:40pt;padding-right:40pt">
            <h3 style="font-family:'Muli';font-weight:500">Activate my TechPost account</h3><BR>
              ...
              <a href="https://gmail.com"><button style="font-size:12pt;letter-spacing:0.5pt;font-weight:500;font-family:Raleway;background-color:#555;border-color:#555;border-style:none;padding:8pt;border-radius:2pt;padding-left:15pt;color:#fff;padding-right:15pt">Continue to Gmail</button></a><BR>
            <BR><BR>
          </div>
        </center>
      </body>
